...
#SBATCH --output="train_desse_${MODEL//\//_}_%j.txt"
...
singularity exec \$SIF bash -c '\$WITH_VENV; which python'lrt
...
while [ \$RETRY_COUNT -lt \$MAX_RETRIES ]; do
   ...
   --cleanenv --rocm --bind /users/$ACCOUNT_NAME/git-projects/DeSSE:/workspace/DeSSE \\
        ...
        train_desse_with_splits.py --train_size=$TRAINSET_SIZE --model=$MODEL --epochs=$EPOCHS
